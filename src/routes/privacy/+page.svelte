...
<div class="flex flex-col gap-6 px-5 py-6">
	...
	<section class="flex flex-col gap-2">
		...
		<ul class="list-disc pl-5 text-foreground [&>li]:mt-1">
			...
			<li><span class="font-medium">Observation data</span> — the insect sightings you tap during a session, session timing, weather, and any notes on habitat conditions or other wildlife.</li>
			<li><span class="font-medium">Location data</span> — GPS coordinates when you create or use a spot/space, or search for an address, and to look up weather for your session.</li>
