...
import { fetchCurrentWeather } from '$lib/server/brightSky';
...
// Real weather for a session, from Bright Sky (DWD open data) — see
// $lib/server/brightSky. Reuses a nearby, recent reading instead of hitting
// the API for every session: most sessions at the same spot within an hour
// of each other share one row.
